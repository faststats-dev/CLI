...
export type DataSourceRecord = { readonly "id": string, readonly "projectId": string, readonly "name": string, readonly "referenceId": string, readonly "dataType": "number" | "string" | "boolean", readonly "regex": string | null, readonly "allowNegative": boolean | null, readonly "allowFloat": boolean | null, readonly "minValue": number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN" | null, readonly "maxValue": number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN" | null, readonly "isArray": boolean, readonly "createdAt": string, readonly "updatedAt": string }
export const DataSourceRecord = Schema.Struct({ "id": Schema.String, "projectId": Schema.String, "name": Schema.String, "referenceId": Schema.String, "dataType": Schema.Literals(["number", "string", "boolean"]), "regex": Schema.Union([Schema.String, Schema.Null]), "allowNegative": Schema.Union([Schema.Boolean, Schema.Null]), "allowFloat": Schema.Union([Schema.Boolean, Schema.Null]), "minValue": Schema.Union([Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])]), Schema.Null]), "maxValue": Schema.Union([Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])]), Schema.Null]), "isArray": Schema.Boolean, "createdAt": Schema.String, "updatedAt": Schema.String })
...
export type DataSourcesCreateDataSourceRequestJson = { readonly "name": string, readonly "referenceId": string, readonly "dataType": "number" | "string" | "boolean", readonly "regex"?: string | null | null, readonly "allowNegative"?: boolean | null | null, readonly "allowFloat"?: boolean | null | null, readonly "minValue"?: number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN" | null | null, readonly "maxValue"?: number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN" | null | null, readonly "isArray"?: boolean | null }
export const DataSourcesCreateDataSourceRequestJson = Schema.Struct({ "name": Schema.String, "referenceId": Schema.String.check(Schema.isMinLength(1)).check(Schema.isPattern(new RegExp("^[a-z0-9_]+$"))), "dataType": Schema.Literals(["number", "string", "boolean"]), "regex": Schema.optionalKey(Schema.Union([Schema.Union([Schema.String, Schema.Null]), Schema.Null])), "allowNegative": Schema.optionalKey(Schema.Union([Schema.Union([Schema.Boolean, Schema.Null]), Schema.Null])), "allowFloat": Schema.optionalKey(Schema.Union([Schema.Union([Schema.Boolean, Schema.Null]), Schema.Null])), "minValue": Schema.optionalKey(Schema.Union([Schema.Union([Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])]), Schema.Null]), Schema.Null])), "maxValue": Schema.optionalKey(Schema.Union([Schema.Union([Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])]), Schema.Null]), Schema.Null])), "isArray": Schema.optionalKey(Schema.Union([Schema.Boolean, Schema.Null])) })
...
export type DataSourcesUpdateDataSourceRequestJson = { readonly "name"?: string | null, readonly "referenceId"?: string | null, readonly "dataType"?: "number" | "string" | "boolean" | null, readonly "regex"?: string | null | null, readonly "allowNegative"?: boolean | null | null, readonly "allowFloat"?: boolean | null | null, readonly "minValue"?: number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN" | null | null, readonly "maxValue"?: number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN" | null | null, readonly "isArray"?: boolean | null }
export const DataSourcesUpdateDataSourceRequestJson = Schema.Struct({ "name": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null])), "referenceId": Schema.optionalKey(Schema.Union([Schema.String.check(Schema.isMinLength(1)).check(Schema.isPattern(new RegExp("^[a-z0-9_]+$"))), Schema.Null])), "dataType": Schema.optionalKey(Schema.Union([Schema.Literals(["number", "string", "boolean"]), Schema.Null])), "regex": Schema.optionalKey(Schema.Union([Schema.Union([Schema.String, Schema.Null]), Schema.Null])), "allowNegative": Schema.optionalKey(Schema.Union([Schema.Union([Schema.Boolean, Schema.Null]), Schema.Null])), "allowFloat": Schema.optionalKey(Schema.Union([Schema.Union([Schema.Boolean, Schema.Null]), Schema.Null])), "minValue": Schema.optionalKey(Schema.Union([Schema.Union([Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])]), Schema.Null]), Schema.Null])), "maxValue": Schema.optionalKey(Schema.Union([Schema.Union([Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])]), Schema.Null]), Schema.Null])), "isArray": Schema.optionalKey(Schema.Union([Schema.Boolean, Schema.Null])) })
...
export type MetricsGetPreviewDataRequestJson = { readonly "queryConfig": { readonly "primaryMetric"?: { readonly "field": string, readonly "aggregation": "sum" | "avg" | "min" | "max" | "count", readonly "label"?: string | null } | null, readonly "metrics"?: ReadonlyArray<{ readonly "field": string, readonly "aggregation": "sum" | "avg" | "min" | "max" | "count", readonly "label"?: string | null }> | null, readonly "dimensions"?: ReadonlyArray<{ readonly "role": "time", readonly "field": string, readonly "interval": "minute" | "hour" | "day" | "week" | "month" } | { readonly "role": "group", readonly "field": string, readonly "limit"?: number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN" | null } | { readonly "role": "series", readonly "field": string }> | null, readonly "filters"?: ReadonlyArray<{ readonly "field": string, readonly "operator": "equals" | "not_equals" | "contains" | "not_contains" | "starts_with" | "not_starts_with" | "ends_with" | "not_ends_with" | "greater_than" | "less_than", readonly "value": string | number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN" | boolean }> | null, readonly "timeRange"?: { readonly "maxAgeMs"?: number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN" | null, readonly "from"?: string | null, readonly "to"?: string | null } | null, readonly "deduplicateServers"?: boolean | null, readonly "mode"?: "history" | "distribution" | null, readonly "groupLimit"?: number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN" | null, readonly "visualOptions"?: { readonly "colors"?: ReadonlyArray<string> | null, readonly "pie"?: { readonly "style"?: "pie" | "donut" | null, readonly "showLegend"?: boolean | null, readonly "showTotal"?: boolean | null, readonly "showLabels"?: boolean | null, readonly "totalDisplayMode"?: "sum" | "count" | null, readonly "drilldown"?: { readonly "enabled"?: boolean | null, readonly "splitPattern"?: string | null } | null } | null, readonly "bar"?: { readonly "stacked"?: boolean | null, readonly "orientation"?: "vertical" | "horizontal" | null } | null, readonly "line"?: { readonly "lineType"?: "monotone" | "linear" | "step" | null, readonly "showDots"?: boolean | null } | null, readonly "widget"?: { readonly "showTrend"?: boolean | null, readonly "displayMode"?: "default" | "compact" | null, readonly "valueFormat"?: "number" | "percent" | null } | null, readonly "list"?: { readonly "selectedTabIndex"?: number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN" | null, readonly "splitPattern"?: string | null, readonly "multiMetric"?: boolean | null } | null, readonly "heatmap"?: { readonly "showLegend"?: boolean | null } | null, readonly "radar"?: { readonly "showDots"?: boolean | null, readonly "fillOpacity"?: number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN" | null, readonly "showLegend"?: boolean | null, readonly "gridType"?: "polygon" | "circle" | null } | null } | null }, readonly "chartType": "widget" | "line" | "area" | "bar" | "pie" | "map" | "list" | "heatmap" | "radar", readonly "flowNodes": ReadonlyArray<{ readonly "id": string, readonly "type"?: string, readonly "data"?: {  }, readonly "position"?: { readonly "x"?: number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN", readonly "y"?: number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN" } }>, readonly "flowEdges": ReadonlyArray<{ readonly "id": string, readonly "source": string, readonly "target": string }> }
export const MetricsGetPreviewDataRequestJson = Schema.Struct({ "queryConfig": Schema.Struct({ "primaryMetric": Schema.optionalKey(Schema.Union([Schema.Struct({ "field": Schema.String, "aggregation": Schema.Literals(["sum", "avg", "min", "max", "count"]), "label": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null])) }), Schema.Null])), "metrics": Schema.optionalKey(Schema.Union([Schema.Array(Schema.Struct({ "field": Schema.String, "aggregation": Schema.Literals(["sum", "avg", "min", "max", "count"]), "label": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null])) })), Schema.Null])), "dimensions": Schema.optionalKey(Schema.Union([Schema.Array(Schema.Union([Schema.Struct({ "role": Schema.Literal("time"), "field": Schema.String, "interval": Schema.Literals(["minute", "hour", "day", "week", "month"]) }), Schema.Struct({ "role": Schema.Literal("group"), "field": Schema.String, "limit": Schema.optionalKey(Schema.Union([Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])]), Schema.Null])) }), Schema.Struct({ "role": Schema.Literal("series"), "field": Schema.String })])), Schema.Null])), "filters": Schema.optionalKey(Schema.Union([Schema.Array(Schema.Struct({ "field": Schema.String, "operator": Schema.Literals(["equals", "not_equals", "contains", "not_contains", "starts_with", "not_starts_with", "ends_with", "not_ends_with", "greater_than", "less_than"]), "value": Schema.Union([Schema.String, Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])]), Schema.Boolean]) })), Schema.Null])), "timeRange": Schema.optionalKey(Schema.Union([Schema.Struct({ "maxAgeMs": Schema.optionalKey(Schema.Union([Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])]), Schema.Null])), "from": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null])), "to": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null])) }), Schema.Null])), "deduplicateServers": Schema.optionalKey(Schema.Union([Schema.Boolean, Schema.Null])), "mode": Schema.optionalKey(Schema.Union([Schema.Literals(["history", "distribution"]), Schema.Null])), "groupLimit": Schema.optionalKey(Schema.Union([Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])]), Schema.Null])), "visualOptions": Schema.optionalKey(Schema.Union([Schema.Struct({ "colors": Schema.optionalKey(Schema.Union([Schema.Array(Schema.String), Schema.Null])), "pie": Schema.optionalKey(Schema.Union([Schema.Struct({ "style": Schema.optionalKey(Schema.Union([Schema.Literals(["pie", "donut"]), Schema.Null])), "showLegend": Schema.optionalKey(Schema.Union([Schema.Boolean, Schema.Null])), "showTotal": Schema.optionalKey(Schema.Union([Schema.Boolean, Schema.Null])), "showLabels": Schema.optionalKey(Schema.Union([Schema.Boolean, Schema.Null])), "totalDisplayMode": Schema.optionalKey(Schema.Union([Schema.Literals(["sum", "count"]), Schema.Null])), "drilldown": Schema.optionalKey(Schema.Union([Schema.Struct({ "enabled": Schema.optionalKey(Schema.Union([Schema.Boolean, Schema.Null])), "splitPattern": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null])) }), Schema.Null])) }), Schema.Null])), "bar": Schema.optionalKey(Schema.Union([Schema.Struct({ "stacked": Schema.optionalKey(Schema.Union([Schema.Boolean, Schema.Null])), "orientation": Schema.optionalKey(Schema.Union([Schema.Literals(["vertical", "horizontal"]), Schema.Null])) }), Schema.Null])), "line": Schema.optionalKey(Schema.Union([Schema.Struct({ "lineType": Schema.optionalKey(Schema.Union([Schema.Literals(["monotone", "linear", "step"]), Schema.Null])), "showDots": Schema.optionalKey(Schema.Union([Schema.Boolean, Schema.Null])) }), Schema.Null])), "widget": Schema.optionalKey(Schema.Union([Schema.Struct({ "showTrend": Schema.optionalKey(Schema.Union([Schema.Boolean, Schema.Null])), "displayMode": Schema.optionalKey(Schema.Union([Schema.Literals(["default", "compact"]), Schema.Null])), "valueFormat": Schema.optionalKey(Schema.Union([Schema.Literals(["number", "percent"]), Schema.Null])) }), Schema.Null])), "list": Schema.optionalKey(Schema.Union([Schema.Struct({ "selectedTabIndex": Schema.optionalKey(Schema.Union([Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])]), Schema.Null])), "splitPattern": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null])), "multiMetric": Schema.optionalKey(Schema.Union([Schema.Boolean, Schema.Null])) }), Schema.Null])), "heatmap": Schema.optionalKey(Schema.Union([Schema.Struct({ "showLegend": Schema.optionalKey(Schema.Union([Schema.Boolean, Schema.Null])) }), Schema.Null])), "radar": Schema.optionalKey(Schema.Union([Schema.Struct({ "showDots": Schema.optionalKey(Schema.Union([Schema.Boolean, Schema.Null])), "fillOpacity": Schema.optionalKey(Schema.Union([Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])]), Schema.Null])), "showLegend": Schema.optionalKey(Schema.Union([Schema.Boolean, Schema.Null])), "gridType": Schema.optionalKey(Schema.Union([Schema.Literals(["polygon", "circle"]), Schema.Null])) }), Schema.Null])) }), Schema.Null])) }), "chartType": Schema.Literals(["widget", "line", "area", "bar", "pie", "map", "list", "heatmap", "radar"]), "flowNodes": Schema.Array(Schema.Struct({ "id": Schema.String, "type": Schema.optionalKey(Schema.String), "data": Schema.optionalKey(Schema.Struct({  })), "position": Schema.optionalKey(Schema.Struct({ "x": Schema.optionalKey(Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])])), "y": Schema.optionalKey(Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])])) })) })), "flowEdges": Schema.Array(Schema.Struct({ "id": Schema.String, "source": Schema.String, "target": Schema.String })) })
export type MetricsGetPreviewData200 = { readonly "data": { readonly "type": "widget", readonly "value": string | number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN", readonly "trend": number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN" } | ReadonlyArray<{ readonly "name": string, readonly [x: string]: string | number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN" }> | { readonly "tabs": ReadonlyArray<ReadonlyArray<{ readonly "name": string, readonly [x: string]: string | number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN" }>> | { readonly [x: string]: ReadonlyArray<{ readonly "name": string, readonly [x: string]: string | number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN" }> } } | null, readonly "flowMeta": { readonly "outputs": ReadonlyArray<{ readonly "id": string, readonly "index": number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN", readonly "name": string, readonly "explicitName"?: string | null, readonly "iconSetId": string | null, readonly "splitPattern"?: string | null, readonly "splitDataSource"?: string | null, readonly "groupField"?: string | null, readonly "primaryMetric"?: { readonly "field": string, readonly "aggregation": string } | null }>, readonly "hasTimeGroup": boolean, readonly "hasBreakdownTimeSeries": boolean, readonly "datasourceFields": ReadonlyArray<string>, readonly "splitLabelSeparator": string, readonly "timeGroupInterval"?: "minute" | "hour" | "day" | "week" | "month" | "auto" | null } }
export const MetricsGetPreviewData200 = Schema.Struct({ "data": Schema.Union([Schema.Struct({ "type": Schema.Literal("widget"), "value": Schema.Union([Schema.String, Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])])]), "trend": Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])]) }), Schema.Array(Schema.StructWithRest(Schema.Struct({ "name": Schema.String }), [Schema.Record(Schema.String, Schema.Union([Schema.String, Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])])]))])), Schema.Struct({ "tabs": Schema.Union([Schema.Array(Schema.Array(Schema.StructWithRest(Schema.Struct({ "name": Schema.String }), [Schema.Record(Schema.String, Schema.Union([Schema.String, Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])])]))]))), Schema.Record(Schema.String, Schema.Array(Schema.StructWithRest(Schema.Struct({ "name": Schema.String }), [Schema.Record(Schema.String, Schema.Union([Schema.String, Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])])]))])))]) }), Schema.Null]), "flowMeta": Schema.Struct({ "outputs": Schema.Array(Schema.Struct({ "id": Schema.String, "index": Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])]), "name": Schema.String, "explicitName": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null])), "iconSetId": Schema.Union([Schema.String, Schema.Null]), "splitPattern": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null])), "splitDataSource": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null])), "groupField": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null])), "primaryMetric": Schema.optionalKey(Schema.Union([Schema.Struct({ "field": Schema.String, "aggregation": Schema.String }), Schema.Null])) })), "hasTimeGroup": Schema.Boolean, "hasBreakdownTimeSeries": Schema.Boolean, "datasourceFields": Schema.Array(Schema.String), "splitLabelSeparator": Schema.String, "timeGroupInterval": Schema.optionalKey(Schema.Union([Schema.Literals(["minute", "hour", "day", "week", "month", "auto"]), Schema.Null])) }) })
...
export type MetricsGetPreviewData500 = InternalServerError
export const MetricsGetPreviewData500 = InternalServerError
export type MetricsLoadDashboardDataRequestJson = { readonly "projectId"?: string | null, readonly "slug"?: string | null, readonly "dashboardId"?: string | null | null, readonly "timeRange"?: { readonly "type": "relative", readonly "maxAgeMs": number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN" } | { readonly "type": "absolute", readonly "fromMs": number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN", readonly "toMs": number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN" } | null, readonly "dashboardFilters"?: ReadonlyArray<{ readonly "field": string, readonly "operator": "equals" | "not_equals" | "greater_equal" | "less_equal", readonly "value": string }> | null, readonly "fusionDebug"?: boolean | null }
export const MetricsLoadDashboardDataRequestJson = Schema.Struct({ "projectId": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null])), "slug": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null])), "dashboardId": Schema.optionalKey(Schema.Union([Schema.Union([Schema.String, Schema.Null]), Schema.Null])), "timeRange": Schema.optionalKey(Schema.Union([Schema.Union([Schema.Struct({ "type": Schema.Literal("relative"), "maxAgeMs": Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])]) }), Schema.Struct({ "type": Schema.Literal("absolute"), "fromMs": Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])]), "toMs": Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])]) })]), Schema.Null])), "dashboardFilters": Schema.optionalKey(Schema.Union([Schema.Array(Schema.Struct({ "field": Schema.String, "operator": Schema.Literals(["equals", "not_equals", "greater_equal", "less_equal"]), "value": Schema.String })), Schema.Null])), "fusionDebug": Schema.optionalKey(Schema.Union([Schema.Boolean, Schema.Null])) })
export type MetricsLoadDashboardData200 = { readonly "charts": { readonly [x: string]: { readonly "type": "widget", readonly "value": string | number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN", readonly "trend": number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN" } | ReadonlyArray<{ readonly "name": string, readonly [x: string]: string | number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN" }> | { readonly "tabs": ReadonlyArray<ReadonlyArray<{ readonly "name": string, readonly [x: string]: string | number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN" }>> | { readonly [x: string]: ReadonlyArray<{ readonly "name": string, readonly [x: string]: string | number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN" }> } } | null }, readonly "flowMeta"?: { readonly [x: string]: { readonly "outputs": ReadonlyArray<{ readonly "id": string, readonly "index": number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN", readonly "name": string, readonly "explicitName"?: string | null, readonly "iconSetId": string | null, readonly "splitPattern"?: string | null, readonly "splitDataSource"?: string | null, readonly "groupField"?: string | null, readonly "primaryMetric"?: { readonly "field": string, readonly "aggregation": string } | null }>, readonly "hasTimeGroup": boolean, readonly "hasBreakdownTimeSeries": boolean, readonly "datasourceFields": ReadonlyArray<string>, readonly "splitLabelSeparator": string, readonly "timeGroupInterval"?: "minute" | "hour" | "day" | "week" | "month" | "auto" | null } } | null, readonly "fusionDebug"?: { readonly "totalCharts": number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN", readonly "totalQueries": number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN", readonly "flowEngineDurationMs"?: number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN" | null, readonly "executionDurationMs"?: number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN" | null, readonly "summary": { readonly "eligibleCharts": number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN", readonly "fusedBatchCount": number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN", readonly "fusedChartCount": number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN", readonly "ineligibleCharts": number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN", readonly "unfusedEligibleCharts": number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN" }, readonly "batches": ReadonlyArray<{ readonly "order": number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN", readonly "kind": "single" | "fused", readonly "durationMs": number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN", readonly "chartIds": ReadonlyArray<string>, readonly "chartNames": ReadonlyArray<string>, readonly "family"?: "time-series-by-output" | "grouping" | "widget" | string | null, readonly "sql"?: string | null, readonly "paramsJson"?: string | null, readonly "datasource"?: string | null }>, readonly "totalDurationMs": number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN" } | null }
export const MetricsLoadDashboardData200 = Schema.Struct({ "charts": Schema.Record(Schema.String, Schema.Union([Schema.Struct({ "type": Schema.Literal("widget"), "value": Schema.Union([Schema.String, Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])])]), "trend": Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])]) }), Schema.Array(Schema.StructWithRest(Schema.Struct({ "name": Schema.String }), [Schema.Record(Schema.String, Schema.Union([Schema.String, Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])])]))])), Schema.Struct({ "tabs": Schema.Union([Schema.Array(Schema.Array(Schema.StructWithRest(Schema.Struct({ "name": Schema.String }), [Schema.Record(Schema.String, Schema.Union([Schema.String, Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])])]))]))), Schema.Record(Schema.String, Schema.Array(Schema.StructWithRest(Schema.Struct({ "name": Schema.String }), [Schema.Record(Schema.String, Schema.Union([Schema.String, Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])])]))])))]) }), Schema.Null])), "flowMeta": Schema.optionalKey(Schema.Union([Schema.Record(Schema.String, Schema.Struct({ "outputs": Schema.Array(Schema.Struct({ "id": Schema.String, "index": Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])]), "name": Schema.String, "explicitName": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null])), "iconSetId": Schema.Union([Schema.String, Schema.Null]), "splitPattern": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null])), "splitDataSource": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null])), "groupField": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null])), "primaryMetric": Schema.optionalKey(Schema.Union([Schema.Struct({ "field": Schema.String, "aggregation": Schema.String }), Schema.Null])) })), "hasTimeGroup": Schema.Boolean, "hasBreakdownTimeSeries": Schema.Boolean, "datasourceFields": Schema.Array(Schema.String), "splitLabelSeparator": Schema.String, "timeGroupInterval": Schema.optionalKey(Schema.Union([Schema.Literals(["minute", "hour", "day", "week", "month", "auto"]), Schema.Null])) })), Schema.Null])), "fusionDebug": Schema.optionalKey(Schema.Union([Schema.Struct({ "totalCharts": Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])]), "totalQueries": Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])]), "flowEngineDurationMs": Schema.optionalKey(Schema.Union([Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])]), Schema.Null])), "executionDurationMs": Schema.optionalKey(Schema.Union([Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])]), Schema.Null])), "summary": Schema.Struct({ "eligibleCharts": Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])]), "fusedBatchCount": Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])]), "fusedChartCount": Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])]), "ineligibleCharts": Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])]), "unfusedEligibleCharts": Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])]) }), "batches": Schema.Array(Schema.Struct({ "order": Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])]), "kind": Schema.Literals(["single", "fused"]), "durationMs": Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])]), "chartIds": Schema.Array(Schema.String), "chartNames": Schema.Array(Schema.String), "family": Schema.optionalKey(Schema.Union([Schema.Union([Schema.Literals(["time-series-by-output", "grouping", "widget"]), Schema.String]), Schema.Null])), "sql": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null])), "paramsJson": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null])), "datasource": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null])) })), "totalDurationMs": Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])]) }), Schema.Null])) })
...
export type MetricsLoadDashboardData500 = InternalServerError
export const MetricsLoadDashboardData500 = InternalServerError
...
export type MetricsGetDashboardFilterSuggestions500 = InternalServerError
export const MetricsGetDashboardFilterSuggestions500 = InternalServerError
...
export type MetricsGetProjectsDashboardData200 = { readonly "stats": { readonly [x: string]: { readonly "events": number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN", readonly "eventsChange": number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN", readonly "users": number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN", readonly "usersChange": number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN", readonly "errors": number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN", readonly "errorsChange": number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN", readonly "lastActivity": string } } }
export const MetricsGetProjectsDashboardData200 = Schema.Struct({ "stats": Schema.Record(Schema.String, Schema.Struct({ "events": Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])]), "eventsChange": Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])]), "users": Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])]), "usersChange": Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])]), "errors": Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])]), "errorsChange": Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])]), "lastActivity": Schema.String })) })
...
export type MetricsGetProjectsDashboardData500 = InternalServerError
export const MetricsGetProjectsDashboardData500 = InternalServerError
export type MetricsGetPublicChartData200 = { readonly "chart": { readonly "id": string, readonly "name": string, readonly "description": string | null, readonly "chartType": "widget" | "line" | "area" | "bar" | "pie" | "map" | "list" | "heatmap" | "radar", readonly "queryConfig": { readonly "primaryMetric"?: { readonly "field": string, readonly "aggregation": "sum" | "avg" | "min" | "max" | "count", readonly "label"?: string | null } | null, readonly "metrics"?: ReadonlyArray<{ readonly "field": string, readonly "aggregation": "sum" | "avg" | "min" | "max" | "count", readonly "label"?: string | null }> | null, readonly "dimensions"?: ReadonlyArray<{ readonly "role": "time", readonly "field": string, readonly "interval": "minute" | "hour" | "day" | "week" | "month" } | { readonly "role": "group", readonly "field": string, readonly "limit"?: number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN" | null } | { readonly "role": "series", readonly "field": string }> | null, readonly "filters"?: ReadonlyArray<{ readonly "field": string, readonly "operator": "equals" | "not_equals" | "contains" | "not_contains" | "starts_with" | "not_starts_with" | "ends_with" | "not_ends_with" | "greater_than" | "less_than", readonly "value": string | number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN" | boolean }> | null, readonly "timeRange"?: { readonly "maxAgeMs"?: number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN" | null, readonly "from"?: string | null, readonly "to"?: string | null } | null, readonly "deduplicateServers"?: boolean | null, readonly "mode"?: "history" | "distribution" | null, readonly "groupLimit"?: number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN" | null, readonly "visualOptions"?: { readonly "colors"?: ReadonlyArray<string> | null, readonly "pie"?: { readonly "style"?: "pie" | "donut" | null, readonly "showLegend"?: boolean | null, readonly "showTotal"?: boolean | null, readonly "showLabels"?: boolean | null, readonly "totalDisplayMode"?: "sum" | "count" | null, readonly "drilldown"?: { readonly "enabled"?: boolean | null, readonly "splitPattern"?: string | null } | null } | null, readonly "bar"?: { readonly "stacked"?: boolean | null, readonly "orientation"?: "vertical" | "horizontal" | null } | null, readonly "line"?: { readonly "lineType"?: "monotone" | "linear" | "step" | null, readonly "showDots"?: boolean | null } | null, readonly "widget"?: { readonly "showTrend"?: boolean | null, readonly "displayMode"?: "default" | "compact" | null, readonly "valueFormat"?: "number" | "percent" | null } | null, readonly "list"?: { readonly "selectedTabIndex"?: number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN" | null, readonly "splitPattern"?: string | null, readonly "multiMetric"?: boolean | null } | null, readonly "heatmap"?: { readonly "showLegend"?: boolean | null } | null, readonly "radar"?: { readonly "showDots"?: boolean | null, readonly "fillOpacity"?: number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN" | null, readonly "showLegend"?: boolean | null, readonly "gridType"?: "polygon" | "circle" | null } | null } | null } | null, readonly "flowNodes": ReadonlyArray<{ readonly "id": string, readonly "type"?: string, readonly "data"?: {  }, readonly "position"?: { readonly "x"?: number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN", readonly "y"?: number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN" } }> | null, readonly "flowEdges": ReadonlyArray<{ readonly "id": string, readonly "source": string, readonly "target": string }> | null }, readonly "projectName": string, readonly "projectPreferredChartColors": ReadonlyArray<string> | null, readonly "data": { readonly "type": "widget", readonly "value": string | number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN", readonly "trend": number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN" } | ReadonlyArray<{ readonly "name": string, readonly [x: string]: string | number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN" }> | { readonly "tabs": ReadonlyArray<ReadonlyArray<{ readonly "name": string, readonly [x: string]: string | number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN" }>> | { readonly [x: string]: ReadonlyArray<{ readonly "name": string, readonly [x: string]: string | number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN" }> } } | null, readonly "flowMeta"?: { readonly "outputs": ReadonlyArray<{ readonly "id": string, readonly "index": number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN", readonly "name": string, readonly "explicitName"?: string | null, readonly "iconSetId": string | null, readonly "splitPattern"?: string | null, readonly "splitDataSource"?: string | null, readonly "groupField"?: string | null, readonly "primaryMetric"?: { readonly "field": string, readonly "aggregation": string } | null }>, readonly "hasTimeGroup": boolean, readonly "hasBreakdownTimeSeries": boolean, readonly "datasourceFields": ReadonlyArray<string>, readonly "splitLabelSeparator": string, readonly "timeGroupInterval"?: "minute" | "hour" | "day" | "week" | "month" | "auto" | null } | null }
export const MetricsGetPublicChartData200 = Schema.Struct({ "chart": Schema.Struct({ "id": Schema.String, "name": Schema.String, "description": Schema.Union([Schema.String, Schema.Null]), "chartType": Schema.Literals(["widget", "line", "area", "bar", "pie", "map", "list", "heatmap", "radar"]), "queryConfig": Schema.Union([Schema.Struct({ "primaryMetric": Schema.optionalKey(Schema.Union([Schema.Struct({ "field": Schema.String, "aggregation": Schema.Literals(["sum", "avg", "min", "max", "count"]), "label": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null])) }), Schema.Null])), "metrics": Schema.optionalKey(Schema.Union([Schema.Array(Schema.Struct({ "field": Schema.String, "aggregation": Schema.Literals(["sum", "avg", "min", "max", "count"]), "label": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null])) })), Schema.Null])), "dimensions": Schema.optionalKey(Schema.Union([Schema.Array(Schema.Union([Schema.Struct({ "role": Schema.Literal("time"), "field": Schema.String, "interval": Schema.Literals(["minute", "hour", "day", "week", "month"]) }), Schema.Struct({ "role": Schema.Literal("group"), "field": Schema.String, "limit": Schema.optionalKey(Schema.Union([Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])]), Schema.Null])) }), Schema.Struct({ "role": Schema.Literal("series"), "field": Schema.String })])), Schema.Null])), "filters": Schema.optionalKey(Schema.Union([Schema.Array(Schema.Struct({ "field": Schema.String, "operator": Schema.Literals(["equals", "not_equals", "contains", "not_contains", "starts_with", "not_starts_with", "ends_with", "not_ends_with", "greater_than", "less_than"]), "value": Schema.Union([Schema.String, Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])]), Schema.Boolean]) })), Schema.Null])), "timeRange": Schema.optionalKey(Schema.Union([Schema.Struct({ "maxAgeMs": Schema.optionalKey(Schema.Union([Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])]), Schema.Null])), "from": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null])), "to": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null])) }), Schema.Null])), "deduplicateServers": Schema.optionalKey(Schema.Union([Schema.Boolean, Schema.Null])), "mode": Schema.optionalKey(Schema.Union([Schema.Literals(["history", "distribution"]), Schema.Null])), "groupLimit": Schema.optionalKey(Schema.Union([Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])]), Schema.Null])), "visualOptions": Schema.optionalKey(Schema.Union([Schema.Struct({ "colors": Schema.optionalKey(Schema.Union([Schema.Array(Schema.String), Schema.Null])), "pie": Schema.optionalKey(Schema.Union([Schema.Struct({ "style": Schema.optionalKey(Schema.Union([Schema.Literals(["pie", "donut"]), Schema.Null])), "showLegend": Schema.optionalKey(Schema.Union([Schema.Boolean, Schema.Null])), "showTotal": Schema.optionalKey(Schema.Union([Schema.Boolean, Schema.Null])), "showLabels": Schema.optionalKey(Schema.Union([Schema.Boolean, Schema.Null])), "totalDisplayMode": Schema.optionalKey(Schema.Union([Schema.Literals(["sum", "count"]), Schema.Null])), "drilldown": Schema.optionalKey(Schema.Union([Schema.Struct({ "enabled": Schema.optionalKey(Schema.Union([Schema.Boolean, Schema.Null])), "splitPattern": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null])) }), Schema.Null])) }), Schema.Null])), "bar": Schema.optionalKey(Schema.Union([Schema.Struct({ "stacked": Schema.optionalKey(Schema.Union([Schema.Boolean, Schema.Null])), "orientation": Schema.optionalKey(Schema.Union([Schema.Literals(["vertical", "horizontal"]), Schema.Null])) }), Schema.Null])), "line": Schema.optionalKey(Schema.Union([Schema.Struct({ "lineType": Schema.optionalKey(Schema.Union([Schema.Literals(["monotone", "linear", "step"]), Schema.Null])), "showDots": Schema.optionalKey(Schema.Union([Schema.Boolean, Schema.Null])) }), Schema.Null])), "widget": Schema.optionalKey(Schema.Union([Schema.Struct({ "showTrend": Schema.optionalKey(Schema.Union([Schema.Boolean, Schema.Null])), "displayMode": Schema.optionalKey(Schema.Union([Schema.Literals(["default", "compact"]), Schema.Null])), "valueFormat": Schema.optionalKey(Schema.Union([Schema.Literals(["number", "percent"]), Schema.Null])) }), Schema.Null])), "list": Schema.optionalKey(Schema.Union([Schema.Struct({ "selectedTabIndex": Schema.optionalKey(Schema.Union([Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])]), Schema.Null])), "splitPattern": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null])), "multiMetric": Schema.optionalKey(Schema.Union([Schema.Boolean, Schema.Null])) }), Schema.Null])), "heatmap": Schema.optionalKey(Schema.Union([Schema.Struct({ "showLegend": Schema.optionalKey(Schema.Union([Schema.Boolean, Schema.Null])) }), Schema.Null])), "radar": Schema.optionalKey(Schema.Union([Schema.Struct({ "showDots": Schema.optionalKey(Schema.Union([Schema.Boolean, Schema.Null])), "fillOpacity": Schema.optionalKey(Schema.Union([Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])]), Schema.Null])), "showLegend": Schema.optionalKey(Schema.Union([Schema.Boolean, Schema.Null])), "gridType": Schema.optionalKey(Schema.Union([Schema.Literals(["polygon", "circle"]), Schema.Null])) }), Schema.Null])) }), Schema.Null])) }), Schema.Null]), "flowNodes": Schema.Union([Schema.Array(Schema.Struct({ "id": Schema.String, "type": Schema.optionalKey(Schema.String), "data": Schema.optionalKey(Schema.Struct({  })), "position": Schema.optionalKey(Schema.Struct({ "x": Schema.optionalKey(Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])])), "y": Schema.optionalKey(Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])])) })) })), Schema.Null]), "flowEdges": Schema.Union([Schema.Array(Schema.Struct({ "id": Schema.String, "source": Schema.String, "target": Schema.String })), Schema.Null]) }), "projectName": Schema.String, "projectPreferredChartColors": Schema.Union([Schema.Array(Schema.String), Schema.Null]), "data": Schema.Union([Schema.Struct({ "type": Schema.Literal("widget"), "value": Schema.Union([Schema.String, Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])])]), "trend": Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])]) }), Schema.Array(Schema.StructWithRest(Schema.Struct({ "name": Schema.String }), [Schema.Record(Schema.String, Schema.Union([Schema.String, Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])])]))])), Schema.Struct({ "tabs": Schema.Union([Schema.Array(Schema.Array(Schema.StructWithRest(Schema.Struct({ "name": Schema.String }), [Schema.Record(Schema.String, Schema.Union([Schema.String, Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])])]))]))), Schema.Record(Schema.String, Schema.Array(Schema.StructWithRest(Schema.Struct({ "name": Schema.String }), [Schema.Record(Schema.String, Schema.Union([Schema.String, Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])])]))])))]) }), Schema.Null]), "flowMeta": Schema.optionalKey(Schema.Union([Schema.Struct({ "outputs": Schema.Array(Schema.Struct({ "id": Schema.String, "index": Schema.Union([Schema.Union([Schema.Number.check(Schema.isFinite()), Schema.Literal("NaN"), Schema.Literal("Infinity"), Schema.Literal("-Infinity")]), Schema.Literals(["Infinity", "-Infinity", "NaN"])]), "name": Schema.String, "explicitName": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null])), "iconSetId": Schema.Union([Schema.String, Schema.Null]), "splitPattern": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null])), "splitDataSource": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null])), "groupField": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null])), "primaryMetric": Schema.optionalKey(Schema.Union([Schema.Struct({ "field": Schema.String, "aggregation": Schema.String }), Schema.Null])) })), "hasTimeGroup": Schema.Boolean, "hasBreakdownTimeSeries": Schema.Boolean, "datasourceFields": Schema.Array(Schema.String), "splitLabelSeparator": Schema.String, "timeGroupInterval": Schema.optionalKey(Schema.Union([Schema.Literals(["minute", "hour", "day", "week", "month", "auto"]), Schema.Null])) }), Schema.Null])) })
export type MetricsGetPublicChartData404 = NotFoundError
export const MetricsGetPublicChartData404 = NotFoundError
export type MetricsGetPublicChartData500 = InternalServerError
export const MetricsGetPublicChartData500 = InternalServerError
